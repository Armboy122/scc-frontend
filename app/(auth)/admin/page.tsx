...
import type { PhaseFeatureFlags } from '@/lib/featureFlags'
...
const links = [
  {
    href: '/admin/users',
    label: 'ผู้ใช้งาน',
    description: 'บทบาท ย้ายสำนักงาน และสถานะบัญชี',
    icon: Users,
  },
  {
    href: '/admin/reports',
    label: 'รายงาน',
    description: 'สรุปและส่งออกข้อมูล',
    icon: FileBarChart,
    feature: 'phase3Expansion' as keyof PhaseFeatureFlags,
  },
]
